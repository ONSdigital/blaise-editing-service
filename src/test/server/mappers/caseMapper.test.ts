...
describe('Map case response to case summary', () => {
  ...
  it('It should return the expected sex for all respondents when given valid inputs for multiple respondent', () => {
    // arrange
    SetFieldsToValue(caseResponseData, 'dmhSize', ''); // 'hhsize' in B4, check with BDSS?
    SetFieldsToValue(caseResponseData, '].Sex', '');
  ...
  it('It should return the expected marital status for all respondents when given valid inputs for multiple respondent', () => {
    // arrange
    SetFieldsToValue(caseResponseData, 'dmhSize', ''); // 'hhsize' in B4, check with BDSS?
    SetFieldsToValue(caseResponseData, '].livewith', '');
    SetFieldsToValue(caseResponseData, '].ms', '');
