...
describe('Authentication file tests', () => {
  ...
  it.each(['FRS Researcher'])('should return the expected surveys for the FRFRS Researcherole', (role) => {
    // arrange
    const sut = new ServerConfigurationProvider();
  ...
  it.each(['FRS Researcher'])('should return the expected outcome configuration for FRFRS Researcherole for FRS', (role) => {
    // arrange
    const sut = new ServerConfigurationProvider();
  ...
  it.each(['FRS Researcher'])('should return the expected organisation configuration for FRFRS Researcherole for FRS', (role) => {
    // arrange
    const sut = new ServerConfigurationProvider();
