...
import { mockCaseSummaryResponse } from "../test-utils/case.mock.js";

import toCaseSummary from "./caseMapper.js";
...
type MutableCaseResponse = Omit<CaseResponse, "fieldData"> & {
  fieldData: Record<string, CaseResponse["fieldData"][string]>;
};

function setFieldsToValue(
  caseResponseData: MutableCaseResponse,
  fieldEndsWith: string,
  fieldValue: string,
): void {
...
let caseResponseData: MutableCaseResponse;

describe("Map case response to case summary", () => {
  beforeEach(() => {
    vi.resetModules();
    caseResponseData = JSON.parse(JSON.stringify(mockCaseSummaryResponse)) as MutableCaseResponse;
  });
  ...
  it("It should return a correctly mapped summary with respondent(s)", () => {
    ...
    const result = toCaseSummary(inputCaseResponseData);

    expect(result).toEqual(expectedSummaryDetails);
  });

  it.each(["one", "dyhzjsgfkb", "0", "", " "])(
    "It should return no respondents when household size is missing or invalid",
    (value) => {
      setFieldsToValue(caseResponseData, "dmhSize", "");
      caseResponseData.fieldData["dmhSize"] = value;

      const result = toCaseSummary(caseResponseData);

      expect(result.NumberOfRespondents).toEqual(value);
  ...
  it.each([
    ...
    "It should return the expected Accomadation Main when given valid inputs",
    (inputValue: string, expectedOutputValue: string) => {
  ...
  it.each([
    ...
    "It should return the expected Accomadation Main when given invalid inputs",
    (inputValue: string, expectedOutputValue: string) => {
      setFieldsToValue(caseResponseData, "qhAdmin.QObsSheet.MainAcD", "");
      caseResponseData.fieldData["qhAdmin.QObsSheet.MainAcD"] = inputValue;
  ...
  it.each([
    ...
    "It should return the expected Accomadation Type when given valid inputs",
    (inputValue: string, expectedOutputValue: string) => {
  ...
  it.each([
    ...
    "It should return the expected Accomadation Type when given invalid inputs",
    (inputValue: string, expectedOutputValue: string) => {
      setFieldsToValue(caseResponseData, "qhAdmin.QObsSheet.TypAcDV", "");
      caseResponseData.fieldData["qhAdmin.QObsSheet.TypAcDV"] = inputValue;
  ...
  it.each([
    ...
    "It should return the expected HouseStatus when given valid inputs",
    (inputValue: string, expectedOutputValue: string) => {
  ...
  it.each([
    ...
    "It should return the expected HouseStatus when given invalid inputs",
    (inputValue: string, expectedOutputValue: string) => {
      setFieldsToValue(caseResponseData, "qAccomdat.HHStat", "");
      caseResponseData.fieldData["qAccomdat.HHStat"] = inputValue;
  ...
  it.each([
    ...
    "It should return the expected CouncilTaxBand when given valid inputs",
    (inputValue: string, expectedOutputValue: string) => {
  ...
  it.each([
    ...
    "It should return the expected CouncilTaxBand when given invalid inputs",
    (inputValue: string, expectedOutputValue: string) => {
      setFieldsToValue(caseResponseData, "qCounTax.CTBand", "");
      caseResponseData.fieldData["qCounTax.CTBand"] = inputValue;
  ...
  it.each([
    ...
    "It should return the expected ReceiptOfHousingBenefit when only one person has this set",
    (PeriodCodeInput: string, expectedPeriodCode: string) => {
  ...
  it.each([
    ...
    "It should return the expected PeriodCode when given an invalid input for only one person",
    (PeriodCodeInput: string, expectedPeriodCode: string) => {
      setFieldsToValue(caseResponseData, ".HBenAmt", "");
      setFieldsToValue(caseResponseData, ".HBenPd", "");
  ...
  it.each([
    ...
    "It should return true for BusinessRoom when it is set for any person",
    (benefitUnitToSet: string, selfEmployedToSet: string, adultToSet: string) => {
      ...
      caseResponseData.fieldData[
        `bU[${benefitUnitToSet}].QSelfJob[${selfEmployedToSet}].Adult[${adultToSet}].BusRoom`
      ] = "1";
  ...
  it.each([
    ...
    "It should return true for SelfEmployed with a list of self employed members when there is only one set",
    (benefitUnitToSet: string, adultToSet: string, personIdToSet: string) => {
      setFieldsToValue(caseResponseData, ".QBUId.BUNum", "");
      setFieldsToValue(caseResponseData, ".EmpStat", "");
      setFieldsToValue(caseResponseData, ".PersId", "");

      caseResponseData.fieldData[`bU[${benefitUnitToSet}].QBUId.BUNum`] = "1";
      caseResponseData.fieldData[`bU[${benefitUnitToSet}].QCurSt1.Adult[${adultToSet}].EmpStat`] =
        "2";
      caseResponseData.fieldData[`bU[${benefitUnitToSet}].QCurSt1.Adult[${adultToSet}].PersId`] =
        `${personIdToSet}`;
  ...
  it.each([
    ...
    "It should return true for IncomeSupport with a list of income support members when there is only one set",
    (benefitUnitToSet: string, adultToSet: string, personIdToSet: string) => {
      setFieldsToValue(caseResponseData, ".QBUId.BUNum", "");
      ...
      caseResponseData.fieldData[`bU[${benefitUnitToSet}].QBUId.BUNum`] = "1";
      caseResponseData.fieldData[
        `bU[${benefitUnitToSet}].QBenefit.QWageBen.Adult[${adultToSet}].WageBen`
      ] = "5";
      caseResponseData.fieldData[
        `bU[${benefitUnitToSet}].QBenefit.QWageBen.Adult[${adultToSet}].PersId`
      ] = `${personIdToSet}`;
  ...
  it.each([
    ...
    "It should return true for IncomeBasedJaSupport with a list of income based Ja members when there is only one set",
    (benefitUnitToSet: string, adultToSet: string, JsaTypeToSet: string, personIdToSet: string) => {
      setFieldsToValue(caseResponseData, ".QBUId.BUNum", "");
      ...
      caseResponseData.fieldData[`bU[${benefitUnitToSet}].QBUId.BUNum`] = "1";
      caseResponseData.fieldData[
        `bU[${benefitUnitToSet}].QBenefit.QWageBen.Adult[${adultToSet}].JSAType`
      ] = `${JsaTypeToSet}`;
      caseResponseData.fieldData[
        `bU[${benefitUnitToSet}].QBenefit.QWageBen.Adult[${adultToSet}].PersId`
      ] = `${personIdToSet}`;
  ...
  it.each(["1", "3", "6", "10"])(
    "It should a respondents array of the the correct size for all Respondents",
    (numberOfRespondents) => {
      setFieldsToValue(caseResponseData, "dmhSize", "");
  ...
  it.each([
    ...
    "It should return the expected sex when given valid inputs",
    (inputValue: string, expectedOutputValue: string) => {
      setFieldsToValue(caseResponseData, "dmhSize", "");
  ...
  it.each([
    ...
    "It should return the expected sex when given invalid inputs",
    (inputValue: string, expectedOutputValue: string) => {
      setFieldsToValue(caseResponseData, "dmhSize", "");
      setFieldsToValue(caseResponseData, "].Sex", "");
  ...
  it.each([
    ...
    "It should return the expected marital status when given valid inputs",
    (inputLivesWithValue: string, inputMaritalStatusValue: string, expectedOutputValue: string) => {
      setFieldsToValue(caseResponseData, "dmhSize", "");
  ...
  it.each([
    ...
    "It should return the expected marital status when given invalid inputs",
    (inputLivesWithValue: string, inputMaritalStatusValue: string, expectedOutputValue: string) => {
      setFieldsToValue(caseResponseData, "dmhSize", "");
      setFieldsToValue(caseResponseData, "].livewith", "");
      setFieldsToValue(caseResponseData, "].ms", "");
