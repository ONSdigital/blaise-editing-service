import { CaseOutcome, EditedStatus, Organisation } from "blaise-api-node-client";

import type { CaseSummaryDetails } from "../../common/types/case.types.js";
import type { CaseEditInformation, CaseResponse } from "blaise-api-node-client";

export const mockCaseAllocatedToRich: CaseEditInformation = {
  primaryKey: "10001011",
...
const mockCaseAllocatedToBob: CaseEditInformation = {
  primaryKey: "10001012",
  outcome: CaseOutcome.Completed,
  assignedTo: "bob",
  interviewer: "",
...
const mockCaseWithQueryStatus: CaseEditInformation = {
  primaryKey: "10001013",
...
const mockCaseInProgress: CaseEditInformation = {
  primaryKey: "10001014",
...
const mockCaseStartedByRichSecond: CaseEditInformation = {
  primaryKey: "10001015",
  outcome: CaseOutcome.Completed,
  assignedTo: "Rich",
  interviewer: "",
...
export const mockCaseList: CaseEditInformation[] = [
  mockCaseAllocatedToRich,
  mockCaseAllocatedToBob,
  mockCaseWithQueryStatus,
  mockCaseInProgress,
  mockCaseStartedByRichSecond,
];

export const mockCaseEmptyList: CaseEditInformation[] = [];

export const mockCaseSummaryResponse: CaseResponse = {
  caseId: "9001",
  fieldData: {
...
export const mockCaseSummaryDetails: CaseSummaryDetails = {
  CaseId: "9001",
  OutcomeCode: "110",
