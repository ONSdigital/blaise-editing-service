import { createSessionKey } from "blaise-login-react-client";

import type { AuthManagerOptions } from "blaise-login-react-client";
...
function getRuntimeAppConfig(): RuntimeAppConfig {
